...
| `GET /api/v1/read-subjects` | Alle bisher beschriebenen Subjects/Streams (Anzahl); optionaler `prefix`-Query für rekursiven Scope | 3 |
...
- **Status:** Akzeptiert (Stufe 1: Health-/Monitoring-Übersicht umgesetzt; Live-Event-Viewer und Subject-Browser als Folgeschritte vorgesehen — siehe [`docs/web-ui-scope.md`](./docs/web-ui-scope.md))
