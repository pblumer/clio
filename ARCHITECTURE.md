...
- **Status:** Akzeptiert (Stufe 1: Health-/Monitoring-Übersicht und Stufe 2: Live-Event-Viewer umgesetzt; Subject-Browser als Folgeschritt vorgesehen — siehe [`docs/web-ui-scope.md`](./docs/web-ui-scope.md))
