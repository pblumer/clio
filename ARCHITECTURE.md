...
| `GET /api/v1/event-stats` | Histogramm der Eventmengen über die Zeit seit Serverstart (Start, Bucket-Breite, Zähler) — fürs `/ui`-Dashboard, ohne die Historie zu streamen | 3 |
